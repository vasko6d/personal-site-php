...
*/
	...
	for (var i = 0; i < 12; ++i){
		...
		if(i%2 != 0){neg = -1}; //ever othey rectangle needs a negative to correctly rotate
...
/////////////////////////////////////////////////////////////////
	...
	//Or it will change the current fractal, or it will begin of stop rotation
		...
		window.onkeydown = function(e) {
			...
			if (kc == 32){
				++cIndex;
				if (cIndex == 7) { cIndex += -7;}
				var ColorsLoc = gl.getUniformLocation(program, "Colors");
				gl.uniform4f(ColorsLoc, colors[cIndex][0],colors[cIndex][1],colors[cIndex][2],colors[cIndex][3]);
			...
			else if (kc == 82){ beginRotation = true;}
			else if (kc == 84){beginRotation = false;}
		};
		//r is 82
		//t is 84
		//" " is 32
